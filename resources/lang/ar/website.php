...
return [
  ...
  'Hotline' => 'الشحن مجانا',
	...
	'bannerLabel1Text'=>'على طلب أكثر من ',
	...
	'Avail free shpping on'=>'الاستفادة الشحن الم,جاني على',
	'Coupon does not belongs to this product'=>'القسيمة لا تنتمي إلى هذا المنتج',
	'You have successfully subscribed.'=>'لقد تم اشتراكك بنجاح.',
	'You have already subscribed.'=>'لقد اشتركت بالفعل.',
	'Some problem occurred, please try again.'=>'حدثت مشكلة ، يرجى المحاولة مرة أخرى.',
	...
	'Currency'=>'عملة',
	'Footer text 1'=>'أبجد هوز دولور الجلوس امات، consectetur adipiscing إيليت.
إنهم يكرهون، يجب أولا الحصول على للتو، وتقديم الانزعاج.',
	...
	'DOWNLOAD OUR APP'=>'تنزيل تطبيقنا',
	'We Using safe payments'=>'نحن نستخدم مدفوعات آمنة',
	'SUBSCRIBE FOR THE LATEST NEWS AND GET 10% DISCOUNT ON SPECIAL ITEMS'=>'اشترك للحصول على أحدث الأخبار واحصل على خصم 10٪ على البنود الخاصة',
	'SUBSCRIBE FOR LATEST UPDATES'=>'الاشتراك للحصول على آخر التحديثات',
	'Sign Up for Our Newsletter'=>'سجل للحصول على اخر اخبارنا',
	'Be the first to learn about our latest trends and get exclusive offers'=>'كن أول من يتعرف على أحدث اتجاهاتنا ويحصل على عروض حصرية.',
	'OK, I agree'=>'حسنا اوافق',
	'This site uses cookies. By continuing to browse the site you are agreeing to our use of cookies. Review our'=>'يستخدم هذا الموقع ملفات تعريف الارتباط. من خلال الاستمرار في تصفح الموقع ، فإنك توافق على استخدامنا لملفات تعريف الارتباط. مراجعة لدينا',
	'cookies information'=>'معلومات ملفات تعريف الارتباط',
...
'Featured Products Detail'=>'وريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور
أنكايديديونتيوت لابوري ات دولار ماجنا أليكيوا . ',
...
أنكايديديونتيوت لابوري ات دولار ماجنا أليكيوا . ',
	...
	'Minutes'=>'الحد الأدنى',
	'Seconds'=>'ثانية',
	'Countdown Timer'=>'للعد التنازلي',
	'Banner 1'=>'حذاء رياضة',
	'Banner 1 Text'=>'أحذية الأزواج',
	'Banner 2'=>'حذاء رياضة',
	'Banner 2 Text'=>'ية الأزواج',
	'View All Range'=>'عرض كل المدى',
...
كيو أوفيسيا ديسيريونتموليت انيم أيدي ايست لابوريوم.',
	...
	'FAX'=>'الفاكس',
	'COMPARE PRODUCT'=>'قارن المنتج',
	'Thank You'=>'شكرا جزيلا',
	'You have successfully place your order'=>'لقد قدمت طلبك بنجاح.',
	...
	'Please fill all the input fields'=>'يرجى ملء جميع حقول الإدخال.',
	'New and confirm password does not match'=>'كلمة المرور الجديدة وتأكيدها غير متطابقة.',
	'Please enter at least 6 characters'=>'الرجاء إدخال 6 أحرف على الأقل.',
	'New Price'=>'سعر جديد',
	'Enter Your Zip / Postal Code'=>'أدخل الرمز البريدي الخاص بك',
	...
	'modal_text_1' => 'أبجد هوز الجزر',
	'awesome_5_stars'=>'رائع - 5 نجوم',
	'pretty_good_4_stars'=>'جيد جدًا - 4 نجوم',
	'pretty_good_3_stars'=>'جيد جدًا - 3 نجوم',
	'meh_2_stars'=>'مه - 2 نجمة',
	'meh_1_stars'=>'مه - 1 نجمة',
	'twitter'=>'تويتر',
	'google'=>'جوجل',
	'Instagram'=>'انستغرام',
	'logo'=>'شعار',
	...
	'swift'=>'سويفت',
	'View Order Detail'=>'عرض تفاصيل الطلب',
	'TAGS'=>'العلامات',
	'Compare' => 'قارن',
	'write your message here'=>'اكتب رسالتك هنا',
	'Cart out stock' => 'نفد هذا المنتج من المخازن.',
	'Cart min order' => 'الحد الأدنى لكمية الطلب المسموح بها لهذا المنتج هو',
	'Cart max order' => 'الحد الأقصى لكمية الطلب المسموح بها لهذا المنتج هي',
	'Min order Price' => 'سعر طلبك أقل من سعر الطلب الأدنى',
	'Coupon Removed' => 'تمت إزالة القسيمة بسبب تجاوز حد استخدام القسيمة',
];
