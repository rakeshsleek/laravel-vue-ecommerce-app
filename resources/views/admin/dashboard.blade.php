                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-info">
                                            ...
                                            @foreach($total_orders as $key=>$orders)
                                                ...
                                                <?php //dd($orders); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($result['commonContent']['currency']->symbol_left)) {{$result['commonContent']['currency']->symbol_left}} @endif {{ floatval($orders->order_price) }} @if(!empty($result['commonContent']['currency']->symbol_right)) {{$result['commonContent']['currency']->symbol_right}} @endif
                                                        </td>
                                                        <td>
                        ...
                        <div class="box-footer clearfix">
                            ...
                            <a href="{{ URL::to('admin/orders/display') }}" class="btn btn-sm btn-default btn-flat pull-right" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.viewAllOrders') }}">{{ trans('labels.viewAllOrders') }}</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!-- /.box -->
