                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select name="web_color_style" class="form-control">
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app')
                                                        selected
                                                        @endif
                                                        value="app">Default</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.1')
                                                        selected
                                                        @endif
                                                        value="app.theme.1"> @lang('labels.app_theme_2')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.2')
                                                        selected
                                                        @endif
                                                        value="app.theme.2"> @lang('labels.app_theme_3')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.3')
                                                        selected
                                                        @endif
                                                        value="app.theme.3"> @lang('labels.app_theme_4')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.4')
                                                        selected
                                                        @endif
                                                        value="app.theme.4"> @lang('labels.app_theme_5')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.5')
                                                        selected
                                                        @endif
                                                        value="app.theme.5"> @lang('labels.app_theme_6')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.6')
                                                        selected
                                                        @endif
                                                        value="app.theme.6"> @lang('labels.app_theme_7')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.7')
                                                        selected
                                                        @endif
                                                        value="app.theme.7"> @lang('labels.app_theme_8')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.8')
                                                        selected
                                                        @endif
                                                        value="app.theme.8"> @lang('labels.app_theme_9')</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.9')
                                                        selected
                                                        @endif
                                                        value="app.theme.9"> Orange</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.10')
                                                        selected
                                                        @endif
                                                        value="app.theme.10"> Cameo</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.11')
                                                        selected
                                                        @endif
                                                        value="app.theme.11"> Americano</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.12')
                                                        selected
                                                        @endif
                                                        value="app.theme.12"> Cranberry</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.13')
                                                        selected
                                                        @endif
                                                        value="app.theme.13"> Pale Sky</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.14')
                                                        selected
                                                        @endif
                                                        value="app.theme.14"> Sheen Green</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.15')
                                                        selected
                                                        @endif
                                                        value="app.theme.15"> Cyan / Aqua</option>
                                                        
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.16')
                                                        selected
                                                        @endif
                                                        value="app.theme.16"> Crete</option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.17')
                                                        selected
                                                        @endif
                                                        value="app.theme.17"> Downy </option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.18')
                                                        selected
                                                        @endif
                                                        value="app.theme.18"> Tonys Pink </option>
                                                <option @if($result['commonContent']['setting']['web_color_style'] == 'app.theme.19')
                                                        selected
                                                        @endif
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select name="web_card_style" class="form-control">
                                              <option @if($result['commonContent']['setting']['web_card_style'] == '1')
                                                selected
                                                @endif
                                                value="1"> @lang('labels.Style1')</option>    
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '2')
                                                    selected
                                                    @endif
                                                    value="2"> @lang('labels.Style2')</option>    
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '3')
                                                    selected
                                                    @endif
                                                    value="3"> @lang('labels.Style3')</option>   
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '4')
                                                    selected
                                                    @endif
                                                    value="4"> @lang('labels.Style4')</option>  
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '5')
                                                    selected
                                                    @endif
                                                    value="5"> @lang('labels.Style5')</option>   
                                                    
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '6')
                                                    selected
                                                    @endif
                                                    value="6"> @lang('labels.Style6')</option>   
                                                    
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '7')
                                                selected
                                                @endif
                                                value="7"> @lang('labels.Style7')</option>    
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '8')
                                                selected
                                                @endif
                                                value="8"> @lang('labels.Style8')</option>     
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '9')
                                                selected
                                                @endif
                                                value="9"> @lang('labels.Style9')</option>               
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '10')
                                                selected
                                                @endif
                                                value="10"> @lang('labels.Style10')</option>   
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '11')
                                                selected
                                                @endif
                                                value="11"> @lang('labels.Style11')</option> 
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '12')
                                                selected
                                                @endif
                                                value="12"> @lang('labels.Style12')</option>
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '13')
                                                selected
                                                @endif
                                                value="13"> @lang('labels.Style13')</option>
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '14')
                                                selected
                                                @endif
                                                value="14"> @lang('labels.Style14')</option>
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '15')
                                                selected
                                                @endif
                                                value="15"> @lang('labels.Style15')</option>

                                                <!-- quantity cards -->
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '16')
                                                selected
                                                @endif
                                                value="16"> @lang('labels.Style16')</option>
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '17')
                                                selected
                                                @endif
                                                value="17"> @lang('labels.Style17')</option>
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '18')
                                                selected
                                                @endif
                                                value="18"> @lang('labels.Style18')</option>
                                                
                                                <!-- <option @if($result['commonContent']['setting']['web_card_style'] == '19')
                                                selected
                                                @endif
                                                value="19"> @lang('labels.Style19')</option>
                                                
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '20')
                                                selected
                                                @endif
                                                value="20"> @lang('labels.Style20')</option>
                                                
                                                
                                                <option @if($result['commonContent']['setting']['web_card_style'] == '21')
                                                selected
                                                @endif
